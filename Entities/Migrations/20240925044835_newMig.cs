        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    avtor = table.Column<bool>(type: "boolean", nullable: true),
                    status_id = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status_id = table.Column<int>(type: "integer", nullable: true),
                    assessor_id = table.Column<int>(type: "integer", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    fixed_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    avtor = table.Column<bool>(type: "boolean", nullable: true),
                    number_authors = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    scientific_title = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_blog_20ts24tu", x => x.id);
                    table.ForeignKey(
                        name: "FK_person_blog_20ts24tu_persons_data_20ts24tu_person_data_id",
                        column: x => x.person_data_id,
                        principalTable: "persons_data_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_blog_20ts24tu_statuses_20ts24tu_status_id",
                        column: x => x.status_id,
                        principalTable: "statuses_20ts24tu",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "person_experience_20ts24tu",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_experience_20ts24tu", x => x.id);
                    table.ForeignKey(
                        name: "FK_person_experience_20ts24tu_persons_data_20ts24tu_person_dat~",
                        column: x => x.person_data_id,
                        principalTable: "persons_data_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_experience_20ts24tu_statuses_20ts24tu_status_id",
                        column: x => x.status_id,
                        principalTable: "statuses_20ts24tu",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "person_portfolio_20ts24tu",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_portfolio_20ts24tu", x => x.id);
                    table.ForeignKey(
                        name: "FK_person_portfolio_20ts24tu_persons_data_20ts24tu_person_data~",
                        column: x => x.person_data_id,
                        principalTable: "persons_data_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_portfolio_20ts24tu_statuses_20ts24tu_status_id",
                        column: x => x.status_id,
                        principalTable: "statuses_20ts24tu",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "person_blog_translation_20ts24tu",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    language_id = table.Column<int>(type: "integer", nullable: true),
                    person_blog_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_blog_translation_20ts24tu", x => x.id);
                    table.ForeignKey(
                        name: "FK_person_blog_translation_20ts24tu_languages_20ts24tu_languag~",
                        column: x => x.language_id,
                        principalTable: "languages_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_blog_translation_20ts24tu_person_blog_20ts24tu_perso~",
                        column: x => x.person_blog_id,
                        principalTable: "person_blog_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_blog_translation_20ts24tu_persons_data_translations_~",
                        column: x => x.person_data_id,
                        principalTable: "persons_data_translations_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_blog_translation_20ts24tu_statuses_translations_20ts~",
                        column: x => x.status_id,
                        principalTable: "statuses_translations_20ts24tu",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "person_experience_translation_20ts24tu",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    language_id = table.Column<int>(type: "integer", nullable: true),
                    person_experience_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_experience_translation_20ts24tu", x => x.id);
                    table.ForeignKey(
                        name: "FK_person_experience_translation_20ts24tu_languages_20ts24tu_l~",
                        column: x => x.language_id,
                        principalTable: "languages_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_experience_translation_20ts24tu_person_experience_20~",
                        column: x => x.person_experience_id,
                        principalTable: "person_experience_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_experience_translation_20ts24tu_persons_data_transla~",
                        column: x => x.person_data_id,
                        principalTable: "persons_data_translations_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_experience_translation_20ts24tu_statuses_translation~",
                        column: x => x.status_id,
                        principalTable: "statuses_translations_20ts24tu",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "person_portfolio_translation_20ts24tu",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ...
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    language_id = table.Column<int>(type: "integer", nullable: true),
                    person_portfolio_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_person_portfolio_translation_20ts24tu", x => x.id);
                    table.ForeignKey(
                        name: "FK_person_portfolio_translation_20ts24tu_languages_20ts24tu_la~",
                        column: x => x.language_id,
                        principalTable: "languages_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_portfolio_translation_20ts24tu_person_portfolio_20ts~",
                        column: x => x.person_portfolio_id,
                        principalTable: "person_portfolio_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_portfolio_translation_20ts24tu_persons_data_translat~",
                        column: x => x.person_data_id,
                        principalTable: "persons_data_translations_20ts24tu",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_person_portfolio_translation_20ts24tu_statuses_translations~",
                        column: x => x.status_id,
                        principalTable: "statuses_translations_20ts24tu",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4051), 1, null, null, null, null, null, 0, null, 1, null, "Rektor", null, null },
                    { 2, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4054), 2, null, null, null, null, null, 1, null, 1, null, "Rektorning birinchi o'rinbosari (xorijiy mutaxasis)", null, null },
                    { 3, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4057), 3, null, null, null, null, null, 1, null, 1, null, "Universitetdagi istiqbolli va strategik vazifalarni amalga oshirish masalalari bo'yicha rektor maslahatchisi", null, null },
                    { 4, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4060), 3, null, null, null, null, null, 1, null, 1, null, "Talabalar orasida ijtimoiy ma'naviy muhit barqarorligini ta'minlashga mas'ul bo'lgan rektor maslahatchisi", null, null },
                    { 5, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4062), 4, null, null, null, null, null, 1, null, 1, null, "Kuzatuv kengashi", null, null },
                    { 6, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4065), 4, null, null, null, null, null, 1, null, 1, null, "Jamoatchilik kengashi", null, null },
                    { 7, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4067), 4, null, null, null, null, null, 1, null, 1, null, "Universitet kengashi", null, null },
                    { 8, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4125), 2, null, null, null, null, null, 1, null, 1, null, "Akademik faoliyat bo'yicha prorektor", null, null },
                    { 9, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4172), 2, null, null, null, null, null, 1, null, 1, null, "Yoshlar masalalari va ma'naviy - ma'rifiy ishlar bo'yicha birinchi prorektor", null, null },
                    { 10, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4195), 2, null, null, null, null, null, 1, null, 1, null, "Ilmiy ishlar va innovatsiyalar bo'yicha prorektor", null, null },
                    { 11, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4219), 2, null, null, null, null, null, 1, null, 1, null, "Xalqaro hamkorlik bo'yicha prorektor", null, null },
                    { 12, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4288), 2, null, null, null, null, null, 1, null, 1, null, "Moliya - iqtisod ishlari bo'yicha prorektor", null, null },
                    { 13, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4316), 2, null, null, null, null, null, 1, null, 1, null, "Ishlab chiqarish korxonalar bilan integratsiya bo'yicha prorektor", null, null },
                    { 14, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4129), 5, null, null, null, null, null, 8, null, 1, null, "Akademik faoliyati boshqarmasi", null, null },
                    { 15, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4132), 6, null, null, null, null, null, 8, null, 1, null, "Raqamli ta'lim texnologiyalari markazi", null, null },
                    { 16, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4134), 6, null, null, null, null, null, 8, null, 1, null, "Axborot - resurs markazi", null, null },
                    { 17, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4137), 7, null, null, null, null, null, 8, null, 1, null, "Tahririy nashriyoti va poligrafiya bo'limi", null, null },
                    { 18, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4140), 7, null, null, null, null, null, 8, null, 1, null, "Magistratura bo'limi", null, null },
                    { 19, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4142), 7, null, null, null, null, null, 8, null, 1, null, "Sirtqi bo'lim", null, null },
                    { 20, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4145), 8, null, null, null, null, null, 8, null, 1, null, "O'quv ishlari bo'yicha assistent", null, null },
                    { 21, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4147), 6, null, null, null, null, null, 8, null, 1, null, "Talabalarga xizmat ko'rsatish markazi (Ofis registrator)", null, null },
                    { 22, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4161), 9, null, null, null, null, null, 8, null, 1, null, "Akademik litsey", null, null },
                    { 23, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4164), 10, null, null, null, null, null, 8, null, 1, null, "Andijon transport texnikumi", null, null },
                    { 24, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4166), 10, null, null, null, null, null, 8, null, 1, null, "Samarqand temir yo'l texnikumi", null, null },
                    { 25, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4170), 10, null, null, null, null, null, 8, null, 1, null, "Nukus transport texnikumi", null, null },
                    { 26, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4150), 11, null, null, null, null, null, 21, null, 1, null, "Akademik mobillilikni muvofiqlashtirish va talabalar registratsiyasi (admission ofisi) sektori", null, null },
                    { 27, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4153), 11, null, null, null, null, null, 21, null, 1, null, "Talabalar bilan ishlash sektori", null, null },
                    { 28, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4155), 7, null, null, null, null, null, 21, null, 1, null, "Ikkinchi bo'lim", null, null },
                    { 29, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4158), 7, null, null, null, null, null, 21, null, 1, null, "Talabalarni turar joy bilan ta'minlash ishlarini muvofiqlashtiruvchi bo'lim", null, null },
                    { 30, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4175), 7, null, null, null, null, null, 9, null, 1, null, "Yoshlar bilan ishlash, ma'naviy - ma'rifat bo'limi", null, null },
                    { 31, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4177), 14, null, null, null, null, null, 9, null, 1, null, "Muzey", null, null },
                    { 32, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4180), 15, null, null, null, null, null, 9, null, 1, null, "Psixolog", null, null },
                    { 33, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4182), 16, null, null, null, null, null, 9, null, 1, null, "Sport inshootlari", null, null },
                    { 34, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4185), 4, null, null, null, null, null, 9, null, 1, null, "Xotin - qizlar maslahat kengashi", null, null },
                    { 35, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4188), 18, null, null, null, null, null, 9, null, 1, null, "TTJ (administratsiya va ishchi xodimlar)", null, null },
                    { 36, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4190), 4, null, null, null, null, null, 9, null, 1, null, "Talabalar kengashi", null, null },
                    { 37, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4193), 7, null, null, null, null, null, 9, null, 1, null, "Yoshlar ittifoqi", null, null },
                    { 38, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4198), 7, null, null, null, null, null, 10, null, 1, null, "Ilmiy - tadqiqotlar, innovatsiyalar va ilmiy - pedagofik kadrlar tayyorlash bo'limi", null, null },
                    { 39, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4201), 7, null, null, null, null, null, 10, null, 1, null, "Iqtidorli talabalarning ilmiy - tadqiqit faoliyatini tashkil etish bo'limi", null, null },
                    { 40, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4203), 7, null, null, null, null, null, 10, null, 1, null, "Ilmiy - innovatsion va loyiha - konstruktorlik bo'limi", null, null },
                    { 41, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4206), 7, null, null, null, null, null, 10, null, 1, null, "Ilmiy nashrlar bilan ishlash bo'limi", null, null },
                    { 42, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4208), 4, null, null, null, null, null, 10, null, 1, null, "Ixtisoslashtirilgan ilmiy kengashlar", null, null },
                    { 43, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4211), 7, null, null, null, null, null, 10, null, 1, null, "Ilmiy - innovatsion ishlanmalarni tijoratlashtirish bo'limi", null, null },
                    { 44, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4213), 6, null, null, null, null, null, 10, null, 1, null, "Ilmiy - tadqiqot markazlari", null, null },
                    { 45, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4216), 8, null, null, null, null, null, 10, null, 1, null, "Tadqiqot ishlari bo'yicha assistent", null, null },
                    { 46, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4222), 5, null, null, null, null, null, 11, null, 1, null, "Xalqaro hamkorlik boshqarmasi", null, null },
                    { 47, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4225), 7, null, null, null, null, null, 11, null, 1, null, "Akademik mobillik va xorijiy grantlar va institutlar bilan ishlash bo'limi", null, null },
                    { 48, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4227), 7, null, null, null, null, null, 11, null, 1, null, "Xalqaro ta'lim dasturlari bilan ishlash bo'limi", null, null },
                    { 49, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4230), 6, null, null, null, null, null, 11, null, 1, null, "O'zbekiston - Turkiya hamkorlik markazi", null, null },
                    { 50, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4283), 6, null, null, null, null, null, 11, null, 1, null, "\"Language Club\" Xorijiy tillar markazi", null, null },
                    { 51, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4286), 6, null, null, null, null, null, 11, null, 1, null, "Xorij bilan hamkorlik markazlari", null, null },
                    { 52, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4291), 7, null, null, null, null, null, 12, null, 1, null, "Moliyalashtirish, buxgalteriya hisobi, hisoboti va tahlili bo'limi - Bosh hisobchi", null, null },
                    { 53, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4293), 5, null, null, null, null, null, 12, null, 1, null, "Ishlar boshqarmasi", null, null },
                    { 54, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4311), 12, null, null, null, null, null, 12, null, 1, null, "O'quv amaliyot poligoni", null, null },
                    { 55, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4313), 13, null, null, null, null, null, 12, null, 1, null, "Omborxona", null, null },
                    { 56, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4296), 7, null, null, null, null, null, 53, null, 1, null, "Xo'jalik bo'limi", null, null },
                    { 57, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4298), 7, null, null, null, null, null, 53, null, 1, null, "Texnik ta'mirlash va tezkor qayta tiklash bo'limi", null, null },
                    { 58, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4301), 7, null, null, null, null, null, 53, null, 1, null, "Fuqaro va mehnat muhofazasi bo'limi", null, null },
                    { 59, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4303), 19, null, null, null, null, null, 53, null, 1, null, "Qozonxona", null, null },
                    { 60, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4306), 7, null, null, null, null, null, 53, null, 1, null, "Transport xizmati bo'limi", null, null },
                    { 61, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4308), 7, null, null, null, null, null, 53, null, 1, null, "Xavfsizlik xizmati bo'limi", null, null },
                    { 62, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4318), 6, null, null, null, null, null, 13, null, 1, null, "Karera markazi", null, null },
                    { 63, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4070), 7, null, null, null, null, null, 1, null, 1, null, "Birinchi bo'lim", null, null },
                    { 64, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4073), 7, null, null, null, null, null, 1, null, 1, null, "Ta'lim sifatini nazorat qilish bo'limi", null, null },
                    { 65, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4075), 20, null, null, null, null, null, 1, null, 1, null, "Ichki audit va moliyaviy nazorat xizmati", null, null },
                    { 66, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4078), 7, null, null, null, null, null, 1, null, 1, null, "Korrupsiyaga qarshi kurashish \"Komplaens - nazorat\" tizimini boshqarish bo'limi", null, null },
                    { 67, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4081), 21, null, null, null, null, null, 1, null, 1, null, "OTM kengashi kotibi", null, null },
                    { 69, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4084), 20, null, null, null, null, null, 1, null, 1, null, "Rektor yordamchisi - protokol xizmati", null, null },
                    { 70, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4086), 23, null, null, null, null, null, 1, null, 1, null, "Yuriskonsult", null, null },
                    { 71, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4089), 20, null, null, null, null, null, 1, null, 1, null, "Matbuot xizmati", null, null },
                    { 72, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4100), 7, null, null, null, null, null, 1, null, 1, null, "Inson resurslarini boshqarish bo'limi", null, null },
                    { 73, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4103), 7, null, null, null, null, null, 1, null, 1, null, "Jismomniy va yuridik shaxslarning murojaatlari bilan ishlash, nazorat va monitoring bo'limi", null, null },
                    { 74, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4115), 24, null, null, null, null, null, 1, null, 1, null, "Devonxona", null, null },
                    { 75, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4118), 25, null, null, null, null, null, 1, null, 1, null, "Arxiv", null, null },
                    { 76, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4120), 7, null, null, null, null, null, 1, null, 1, null, "Xalqaro rwytinglar bilan ishlash bo'limi", null, null },
                    { 77, new DateTime(2024, 9, 25, 4, 48, 32, 165, DateTimeKind.Utc).AddTicks(4123), 7, null, null, null, null, null, 1, null, 1, null, "Raqamli transformatsiya bo'limi", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_document_teacher_110_set_20ts24tu_assessor_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_person_blog_20ts24tu_person_data_id",
                table: "person_blog_20ts24tu",
                column: "person_data_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_blog_20ts24tu_status_id",
                table: "person_blog_20ts24tu",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_blog_translation_20ts24tu_language_id",
                table: "person_blog_translation_20ts24tu",
                column: "language_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_blog_translation_20ts24tu_person_blog_id",
                table: "person_blog_translation_20ts24tu",
                column: "person_blog_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_blog_translation_20ts24tu_person_data_id",
                table: "person_blog_translation_20ts24tu",
                column: "person_data_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_blog_translation_20ts24tu_status_id",
                table: "person_blog_translation_20ts24tu",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_experience_20ts24tu_person_data_id",
                table: "person_experience_20ts24tu",
                column: "person_data_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_experience_20ts24tu_status_id",
                table: "person_experience_20ts24tu",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_experience_translation_20ts24tu_language_id",
                table: "person_experience_translation_20ts24tu",
                column: "language_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_experience_translation_20ts24tu_person_data_id",
                table: "person_experience_translation_20ts24tu",
                column: "person_data_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_experience_translation_20ts24tu_person_experience_id",
                table: "person_experience_translation_20ts24tu",
                column: "person_experience_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_experience_translation_20ts24tu_status_id",
                table: "person_experience_translation_20ts24tu",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_portfolio_20ts24tu_person_data_id",
                table: "person_portfolio_20ts24tu",
                column: "person_data_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_portfolio_20ts24tu_status_id",
                table: "person_portfolio_20ts24tu",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_portfolio_translation_20ts24tu_language_id",
                table: "person_portfolio_translation_20ts24tu",
                column: "language_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_portfolio_translation_20ts24tu_person_data_id",
                table: "person_portfolio_translation_20ts24tu",
                column: "person_data_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_portfolio_translation_20ts24tu_person_portfolio_id",
                table: "person_portfolio_translation_20ts24tu",
                column: "person_portfolio_id");

            migrationBuilder.CreateIndex(
                name: "IX_person_portfolio_translation_20ts24tu_status_id",
                table: "person_portfolio_translation_20ts24tu",
                column: "status_id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_document_teacher_110_set_20ts24tu_users_20ts24tu_assessor_id",
                table: "document_teacher_110_set_20ts24tu",
                column: "assessor_id",
                principalTable: "users_20ts24tu",
                principalColumn: "id");
