...
namespace TSTUWebAPI.Controllers.BlogsCategoryControllers
{
    ...
    public class BlogCategoryController : ControllerBase
    {
        ...
        public IActionResult GetAllBlogCategoryTranslation(int queryNum, int pageNum)
        {
            queryNum = Math.Abs(queryNum);
            pageNum = Math.Abs(pageNum);
            IEnumerable<BlogCategoryTranslation> blogCategorytranslations1 = _repository.AllBlogCategoryTranslation(queryNum, pageNum);
